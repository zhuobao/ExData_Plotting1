...
#   ppath: csv file path
#   filename: csv file name
plot2 <- function(gpath=".", gfname="plot2.png", ppath=".", filename="household_power_consumption.txt"){
    ...
    ## make chart for plot 1
    xlabtxt=""
    ylabtxt="Global Active Power (kilowatts)"  # customize Y axis label
